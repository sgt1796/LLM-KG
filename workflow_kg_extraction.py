...
run_command("python fetch_ncbi.py --csv csv-GABAORgamm-set.csv --out GABA_papers --resume")
...
# Step 3: Run KG Extraction for Dataset Papers with LLMNER
run_command("python main.py --pdf GABA_papers --output GABA_graph.json --ner ollama --chunking sections")

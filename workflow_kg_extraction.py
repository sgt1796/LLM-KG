...
run_command("python KG_visualizer.py --k-core 1 --max-nodes 300 --label-top 10 --highlight-edges-top 20 --edge-labels-top 10 --min-weight 5 --input graph_dataset3_llm.json --layout spring --largest-only")

# Step 6: Visualize using Pyvis
run_command("python pyvis_view.py --input graph_dataset3_llm.json --html graph_dataset3_llm.html --weight \">=0\" --k-core 0 --max-nodes 500 --max-edges 600 --label-top 20 --physics barnesHut")
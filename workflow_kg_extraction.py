...
run_command("python main.py --pdf papers --output graph_llm.json --ner ollama --chunking sections")
...
run_command("python pyvis_view.py --input graph_llm.json --html graph_llm.html --weight \">=0\" --k-core 0 --max-nodes 500 --max-edges 600 --label-top 20 --physics barnesHut --largest-only --directed --filter-menu")